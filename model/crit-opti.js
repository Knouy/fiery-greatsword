  ...
  $(() => {
    ...
    $('#P\\.AGONY_RESISTANCE').on('change', () => {
      ...
      if (AGONY_RESISTANCE.value === '' || AGONY_RESISTANCE.value.replace('.',
        ...
        // noinspection JSUnresolvedVariable
        P.AGONY_RESISTANCE = AGONY_RESISTANCE.value.replace('.', '') > 605
          ? 605
    ...
    $('#P\\.VITALITY').on('change', () => {
      ...
      if (VITALITY.value === '' || VITALITY.value.replace('.', '') < 1000) {
        ...
        // noinspection JSUnresolvedVariable
        P.VITALITY = VITALITY.value.replace('.', '') > 9999
          ? 9999
          : VITALITY.value.replace('.', '');
      }
      // noinspection JSUnresolvedVariable
    ...
    /* ////////////////////////////////////////////////////// *//* Consumable */
    /* ************************** *//* Anguished Tear of Alba *//* Consumable */
    ...
    /* ////////////////////////////////////////////// *//* Fractal Attunement */
    /* ************************* *//* Agony Channeler *//* Fractal Attunement */
    ...
    /* ******************** *//* Recursive Resourcing *//* Fractal Attunement */
    ...
    /* ****************** *//* Mistlock Singularities *//* Fractal Attunement */
    ...
    $('#P\\.AGONY_IMPEDANCE').on('change', () => {
      ...
      if (AGONY_IMPEDANCE.value === '' || AGONY_IMPEDANCE.value.replace('.',
        ...
        AGONY_IMPEDANCE.value = AGONY_IMPEDANCE.value.replace('.', '') > 4
          ? 4
    ...
    /* ///////////////////////////////////////////////// *//* Mist Attunement */
    /* ************************** *//* Mist Attunement 1 *//* Mist Attunement */
    ...
    /* ************************** *//* Mist Attunement 2 *//* Mist Attunement */
    ...
    /* ************************** *//* Mist Attunement 3 *//* Mist Attunement */
    ...
    /* ************************** *//* Mist Attunement 4 *//* Mist Attunement */
    ...
    /* *************************** *//* Superior Sigil of Accuracy *//* Sigil */
    ...
    const UTILITY_SKILL_RADIO = ['P.SIGNET_OF_AGILITY', 'P.SIGNET_OF_FIRE',
      'P.SIGNET_OF_FURY'];
    /* **************************** *//* Signet of Agility *//* Utility skill */
